...
SYSTEM_PROMPT = (
    ...
    "If a word or name in my message seems garbled, misspelled, or mis-transcribed "
    "(common with voice), first match it to a similar-sounding name or term from our "
    "recent conversation and just GO with the closest sensible match — answer directly as "
    "if I'd said it correctly. Do NOT open with 'I need to clarify', list other "
    "possibilities, or ask me to rephrase; at most a brief 'Assuming you mean X,' then "
    "answer. E.g. 'wing lay' right after we discussed the Las Vegas restaurant 'Wing Lei' "
    "means Wing Lei — answer about Wing Lei. Only ask if truly nothing in context fits. "
